...
def main():
    ...
    for split in ['train', 'val', 'test']:
        neptune_exp.log_text(f"{split}_data_version", md5(f"../Dataset/processed/{split}.json"))
    ...
    if args.resume:
        ...
        neptune_exp.log_text("model_version", model_hash)
    else:
        ...
        neptune_exp.log_artifact(path_new_opt)
        neptune_exp.log_artifact(path_args)
